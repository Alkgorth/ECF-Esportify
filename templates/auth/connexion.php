...
<div class="container-fluid px-5 mt-4 row d-flex justify-content-center">
    ...
    <form method="POST" class="col-sm-6 mb-3 mx-auto justify-content-center">
        ...
        <div class="d-flex justify-content-center p-2">
            <button type="submit" class="btn bouton-connexion mb-2 me-4 texte-bouton" name="connexion">Connexion</button>
            <button class="btn bouton-create mb-3 ms-4">
        ...
        <div>
            <div class="text-center">
                <button class="mb-3 btn btn-dark text-center bouton-mdp-oublie">
