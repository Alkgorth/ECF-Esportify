...
<header>
    <nav>
        ...
        <!-- BARRE DE NAVIGATION TUTO YOUTUBE -->


        <!-- <div id="nav nav-latteral" class="nav-latteral position-absolute top-0 bg-white z-3">
    <div id="nav-close" class="nav-button mb-4">
    ...
    <div class="nav-links pt-1 pe-6 ps-1 pb-3">
        <div class="nav-link d-flex fs-3 align-items-center">
        ...
        <div class="nav-link d-flex fs-3 align-items-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" class="bi bi-gear-fill" viewBox="0 0 16 16">
...
<div id="nav-wrapper" class="position-absolute top-0 start-0 z-2 d-none"></div>
