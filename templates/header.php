...
?>
<header>
    <nav class="navbar bg-white position-fixed top-0 start-0 w-auto h-100" id="navbar">
        <ul class="navbar-nav flex-shrink-0 list-unstyled ps-0 flex-grow-1 z-3 d-flex flex-column">
            <li class="nav-item">
                <a href="#" class="nav-link d-flex  p-3 m-3 border-bottom">
                    <img src="#" class="logo" alt="Logo Esportify">
                </a>
            </li>
            ...
            <li class="mb-1 ms-3 nav-item">
                <a href="#" class="nav-link ">
                    <form class="d-flex " role="search">
                        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" width="2.5em" height="2.5em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-search border rounded p-2 me-2">
